...
- Temperatures, SMART health best-effort, Linux power profile/governor, macOS Apple Silicon thermal/CPU limit hints.
...
- Allowlisted remote tasks с minimal env, output cap, shell denylist и audit log.
- Policy-gated PTY primitive для будущего remote shell.
- Self-update: download, SHA256 verify, Ed25519 signature verify, atomic replace.
